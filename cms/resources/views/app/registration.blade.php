      ...
      <form method="post" action="{{ route('app.registration.post') }}">
        ...
        <div class="form-group">
          ...
          <input id="company_name" name="company_name" value="{{ old('company_name') }}" type="text"
                 class="form-control" placeholder='Acme Inc.' required autofocus>
        </div>
        <div class="form-group">
          <label for="company_domain">Shop Domain</label>
          <div class="input-group">
            <input id="company_domain" name="company_domain" value="{{ old('company_domain') }}" type="text"
                   class="form-control" placeholder="acme" aria-label="Comapny domain" aria-describedby="basic-addon2">
        ...
        @guest
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input id="first_name" name="first_name" value="{{ old('first_name') }}" type="text" class="form-control"
                     placeholder="John">
            </div>
            <div class="form-group col-md-6">
              <label for="last_name">Last Name</label>
              <input id="last_name" name="last_name" value="{{ old('last_name') }}" type="text" class="form-control"
                     placeholder="Doe">
            </div>
          </div>
