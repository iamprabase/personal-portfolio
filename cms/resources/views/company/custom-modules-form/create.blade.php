            ...
            <div class="col-xs-12">
                <div class="box box-default">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <div class="col-xs-7 page-action text-right">
                                <a href="{{ domain_route('company.admin.custom.modules.form.index',['id' => $custom_fields->id]) }}"
                    ...
                    <div class="box-body">
                        ...
                        <form action="{{route('company.admin.custom.modules.dynamic.form.store',['domain' => request('subdomain'),'id'=>$custom_fields->id])}}"
                            ...
                            <button class="btn btn-primary pull-right keySubmit"
                                    @if($custom_fields->customFields->count() == 0) disabled @endif>Submit
                            </button>
                        </form>
                    </div>
