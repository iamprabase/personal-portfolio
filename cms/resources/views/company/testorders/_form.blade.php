  ...
  <div class="col-xs-4">
    <div class="form-group @if ($errors->has('client_id')) has-error @endif">
      ...
      <div class="input-group" style="width: 100% !important">
        {{-- {!! Form::select('client_id', $clients, isset($order)?$order->client_id:null,  ['class' => 'form-control select2','required']) !!} --}}

        <select name="client_id" class= "form-control select2" id="order_clients">
          {{--<option selected disabled>Please Select</option>--}}
          @foreach($clients as $client)
            {{--@if($client->superior==)--}}
            <option value="{{$client['id']}}" {{isset($order)?$order->client_id==$client['id']?"selected":null:null}} data-rate={{$client['rate_id']}}>{{$client['company_name']}}</option>
            {{--@endif--}}
          @endforeach
        </select>
      </div>
...
{{--<div id="test"></div>--}}
    {{--<div class="col-xs-3">--}}
        {{--<div class="form-group @if ($errors->has('client_id')) has-error @endif">--}}
            ...
            {{--<div class="input-group" style="width: 100% !important">--}}
                ...
                {{--<select name="client_type" class= "form-control select2" id="test">--}}
  ...
  <div class="col-xs-4">
    <div class="form-group @if ($errors->has('orderTo')) has-error @endif">
      {!! Form::label('orderTo', 'Order To') !!}<span style="color: red">*</span>
      <div class="input-group" style="width: 100% !important">
