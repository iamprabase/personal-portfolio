    ...
    <div class="col-xs-12">
      ...
      <div class="box">
        <div class="box-header">
          ...
          <a href="{{ domain_route('company.admin.testordercreate') }}" class="btn btn-primary pull-right"
  ...
  $('document').ready(function () {
      ...
      $('#stsfilterdrop').multiselect({
        ...
        onChange: function(option, checked, select) {
          ...
          initializeDT(empVal, partyVal, start, end, stsValues, outlet_search, beatfilter);
        },
      ...
      @if($nCal==0)
        ...
        $('#reportrange').on('apply.daterangepicker', function(ev, picker) {
          ...
          if(start != '' || end != '')
          {
            ...
            initializeDT(empVal, partyVal, start, end, stsfilter, outlet_search, beatfilter);
          }
      ...
      initializeDT(outEmpSelVal, partySel, start, end, stsVal, outlet_search, beatVal);
      ...
      function initializeDT(empVal=null, partyVal=null, startD, endD, stsFilters, outlet_search, beatFilters){
          ...
          dt.one('preXhr', function (e, s, data) {
            ...
            dt.one('preDraw', function (e, settings) {
              if(button[0].className=="btn btn-default buttons-pdf buttons-html5"){
                ...
                if(settings.json.data.length>500){
                  alert("Please consider generating the report in chunks. Unable to handle huge requests.");
                }else{
