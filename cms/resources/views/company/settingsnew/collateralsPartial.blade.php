...
<div class="col-xs-3 folderContainer">
    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="false">
        <div class="panel">
                ...
                <div class="panel-body" style="padding:0px 50px 0px 50px;">
                    <div>
                        <a data-id="{{$companyCollateralFolder->id}}" data-folder_name="{{$companyCollateralFolder->folder_name}}"
                            href="{{domain_route('company.admin.settingnew.viewCollateralsFolder',['id'=>$companyCollateralFolder->id])}}"
                    ...
                    <div>
                        ...
                        <a class="btn btn-danger btn-sm collateralFolderDelete" href="{{domain_route('company.admin.settingnew.deleteCollateralsFolder')}}" data-id="{{$companyCollateralFolder->id}}" data-folder_name="{{$companyCollateralFolder->folder_name}}" style="word-break: break-word;" onClick="deleteFolderName(this);">
            ...
            <div class="panel-heading" role="tab" id="heading{{$companyCollateralFolder->id}}" style="display:flex;align-items: center;justify-content: center;height: 37px !important;">
               ...
               <a data-id="{{$companyCollateralFolder->id}}" data-folder_name="{{$companyCollateralFolder->folder_name}}" href="{{domain_route('company.admin.settingnew.viewCollateralsFolder',['id'=>$companyCollateralFolder->id])}}" class="folderTitleClick" style="word-break: break-word;" onClick="loadFileView(this);"><span id="folderNameSpan" class="folderNameSpan">{{$companyCollateralFolder->folder_name}}<span class="tooltiptext">{{$companyCollateralFolder->folder_name}}</span></span></a>
               </span>
            </div>
        </div>
    </div>
