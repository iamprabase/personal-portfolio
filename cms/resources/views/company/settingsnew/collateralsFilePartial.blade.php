...
<div class="col-xs-12 site-tital">
    ...
    <div class="col-xs-2 pull-right" style="top: 15px;">
        <a href="{{ domain_route('company.admin.settingnew.viewCollateralsFolderHome') }}" class="btn btn-default btn-sm"
...
<div class="info col-xs-12" style="max-height: auto;overflow-y: scroll;">
    ...
    <div class="box-body">
        <div class="row appendTableView">
            @include('company.settingsnew.collateralsFileView')
        </div>
    </div>
</div>
...
<div class="modal fade" id="myFileUploadModal" role="dialog">
    <div class="modal-dialog modal-md">
        {!! Form::open(array('url' => url(domain_route("company.admin.settingnew.uploadCollateralsFiles")), 'method' => 'post', 'enctype'=>"multipart/form-data", 'files'=> true, 'id'=>'collateralFileUpload')) !!}
...
<div class="modal fade" id="editFileUploadModal" role="dialog">
    <div class="modal-dialog modal-md">
        {!! Form::open(array('url' => url(domain_route("company.admin.settingnew.editCollateralsFiles")),
    ...
    (function () {
        ...
        $("#addFiles").click(function (e) {
            ...
            $.ajax({ 
                ...
                url: "{{domain_route('company.admin.settingnew.uploadCollateralsFiles')}}", 
                data: formData, 
                dataType:'JSON',
                contentType: false,
                cache: false,
    ...
    (function () {
        ...
        $("#editFiles").click(function (e) {
            ...
            $.ajax({ 
                ...
                url: "{{domain_route('company.admin.settingnew.editCollateralsFiles')}}", 
                data: formData, 
                dataType:'JSON',
                contentType: false,
                cache: false,
