<div class="col-xs-12">
  <div class="box-header">
    <h3 class="box-title">Beats List</h3>
  </div>
</div>
<div class="info">
  <div class="col-xs-6">
    ...
    <div class="">
      ...
      <div class="box-bodys">
        ...
        <div class="form-group @if ($errors->has('name')) has-error @endif">
          ...
          {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Beat Name','id'=>'beatname', 'required']) !!}
    ...
    <div class="modal-dialog small-modal" unit="document">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                aria-hidden="true">&times;</span></button>
          <h4 class="modal-title text-center" id="myModalLabel">Update Beat</h4>
        </div>
