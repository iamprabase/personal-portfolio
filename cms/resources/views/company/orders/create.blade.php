    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                ...
                {!! Form::open(array('url' => url(domain_route("company.admin.order.store", ["domain" =>request("subdomain")])),
                'method' => 'post', 'files'=> true, 'id'=>'orderForm')) !!}
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.addMoreOrder', function () {
                ...
                <option value="{{$product->id}}" data-brand="{{isset($product->brand)?$product->brand:null}}" 
                                        data-category="{{isset($product->category_id)?$product->category_id:null}}"  data-product_name="{{$product->product_name}}"
            ...
            $('select[id="order_clients"]').on('change', function (event) {
                ...
                if (order_to_setup == 0) {
                    ...
                    $.ajax({
                        ...
                        method: "GET",
                        dataType: 'json',
                        data: {client_type: selectedClientType},
                        beforeSend: function () {
                            showLoader()
                        },
                        success: function (response) {
                            ...
                            if (Object.entries(data).length !== 0) {
                                ...
                                Object.keys(filteredParties).map((index, key) => {
                                    let optionEntry = `<optgroup label="${index}">`
        ...
        $("#apply-scheme").on('click', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#exampleModal').modal('hide');
                    // console.log(data.schemes.length)
        ...
        function update_amounts() {
          ...
          <div class="col-xs-12">
            ...
            if (subtotal < scheme_discount) {
                ...
                let initial_value = $('#scheme-amount').val();
            ...
            @elseif ($getClientSetting -> product_level_discount == 1)
