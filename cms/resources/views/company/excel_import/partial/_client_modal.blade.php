                        ...
                        <div class="box">
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-xs-10">
                                        <a href="{{ asset('assets/files/clients.xls') }}" class="btn btn-link"> Download .xls spreadsheet (97-2003)</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box">
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-xs-10">
                                        <a href="{{ asset('assets/files/clients.xlsx') }}" class="btn btn-link"> Download .xlsx spreadsheet (2007 - current)</a>
                                    </div>
                                </div>
                            </div>
                        </div>
