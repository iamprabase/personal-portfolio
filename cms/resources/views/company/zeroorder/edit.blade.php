...
<section class="content">
  <div class="box box-default">
    <div class="box-header with-border">
      <h3 class="box-title">Edit Zero Order</h3>
    ...
    <div class="box-body">
      {!! Form::model($zeroorder, array('url' => url(domain_route('company.admin.zeroorder.update',[$zeroorder->id])) , 'method' => 'POST', 'files'=> true)) !!}
      @method('patch')
...
<script>
  $('.DT_ZeroOrd_FILTER').val(sessionStorage.getItem('DT_ZeroOrd_filters'));
