      ...
      <div class="col-xs-1">
        <div class="box-tools pull-right" style="margin-top: 10px;">
          <div class="col-xs-7 page-action text-right">
            ...
            <a href="@if(URL::previous()!=domain_route('company.admin.employee')){{domain_route('company.admin.employee')}} @else {{ URL::previous() }} @endif" class="btn btn-default btn-sm"> <i class="fa fa-arrow-left"></i> Back</a>
          </div>
        </div>
      </div>
    ...
    $('#tree1').treed();
      ...
      function initializeODT(empID){
        ordertable = $('#order').DataTable({
          ...
          {
            $('#grandTotalAmount').html(settings.json.total);
          }
          @endif
        });
          ...
          var expensetable = $('#expense').DataTable({
              ...
              footerCallback: function (row, data, start, end, display) {
                  ...
                  $('#grandTotalEAmount').html(
                      'Total: '+"{{ config('settings.currency_symbol')}} " + (pageTotal).toLocaleString("en")
                  );
              }
          });
      ...
      function initializeCDT(empID){
        var collectiontable = $('#collection').DataTable({
          ...
          drawCallback:function(settings)
          {
            $('#grandTotalCAmount').html(settings.json.total);
          }
        });
    ...
    $(function(){
      ...
      $('#UpdateCompanyDetail').on('submit',function(e){
        ...
        $.ajax({
              ...
              beforeSend:function(){
                $('#ActivateCompanyUpdate').attr('disabled',true);
              },
              success: function (data) {
                if(data.code===200){
                    alert(data.success);
                    $('#ActivateCompanyUpdate').attr('disabled',false);
                    $('#ActivateCompanyUpdate').addClass('hide');
                    $('#ActivateCompanyCancel').addClass('hide');
                    $('#ActivateCompanyEdit').removeClass('hide');
                    $('.text-form').attr('hidden',true);
      ...
      $('#UpdateBankDetail').on('submit',function(e){
        ...
        $.ajax({
              ...
              beforeSend:function(){
                $('#ActivateBankUpdate').attr('disabled',true);
              },
              success: function (data) {
                if(data.code===200){
                    alert(data.success);
                    $('#ActivateBankUpdate').attr('disabled',false);
                    $('#ActivateBankUpdate').addClass('hide');
                    $('#ActivateBankCancel').addClass('hide');
                    $('#ActivateBankEdit').removeClass('hide');
                    $('.text-form').attr('hidden',true);
      ...
      $('#UpdateDocumentDetail').on('submit',function(e){
        ...
        $.ajax({
              ...
              processData: false,
              beforeSend:function(){
                $('#ActivateDocumentUpdate').attr('disabled',true);
              },
              success: function (data) {
                if(data.code===200){
                    alert(data.success);
                    $('#ActivateDocumentUpdate').attr('disabled',false);
                    $('#ActivateDocumentUpdate').addClass('hide');
                    $('#ActivateDocumentCancel').addClass('hide');
                    $('#ActivateDocumentEdit').removeClass('hide');
                    $('.text-form').attr('hidden',true);
      ...
      $('#UpdateAccountDetail').on('submit',function(e){
        ...
        $.ajax({
              ...
              beforeSend:function(){
                $('#ActivateAccountUpdate').attr('disabled',true);
              },
              success: function (data) {
                if(data.code===200){
                    alert(data.success);
                    $('#ActivateAccountUpdate').attr('disabled',false);
                    $('#ActivateAccountUpdate').addClass('hide');
                    $('#ActivateAccountCancel').addClass('hide');
                    $('#ActivateAccountEdit').removeClass('hide');
                    $('.text-form').attr('hidden',true);
