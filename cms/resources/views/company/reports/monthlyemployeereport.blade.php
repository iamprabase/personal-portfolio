            ...
            <table id="empattendance" class="table table-bordered table-striped">
              ...
              @foreach($attendances as $attendance)
                ...
                <tr id="{{ $i }}" class="prodrow">
                  ...
                  <td>{{getCurrency()}}
                    . {{ getOrders(date('Y-m-d',strtotime($attendance->check_datetime)),$attendance->employee_id)}}</td>
                  <td>{{getCurrency()}}
                    . {{ getCollections(date('Y-m-d',strtotime($attendance->check_datetime)),$attendance->employee_id)}}</td>
...
@section('scripts')
  ...
  <script>
      ...
      //     var stops = [{"Latitude":26.4672404,"Longitude":87.2805553},{"Latitude":26.4674214,"Longitude":87.2838593},{"Latitude":26.4673938,"Longitude":87.2838766},{"Latitude":26.4673775,"Longitude":87.2839147},{"Latitude":26.4672404,"Longitude":87.2805553},{"Latitude":26.467298,"Longitude":87.28068},{"Latitude":26.4672888,"Longitude":87.2806931},{"Latitude":26.4672648,"Longitude":87.2807274},{"Latitude":26.4672553,"Longitude":87.2809771},{"Latitude":26.4672592,"Longitude":87.282891},{"Latitude":26.467027,"Longitude":87.2824327}] ;
