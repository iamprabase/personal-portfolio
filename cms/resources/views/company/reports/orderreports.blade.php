        ...
        <div class="box">
          ...
          <div class="box-body tablediv">
            <div class="container-fluid" style="width:auto;">
              <div class="col-md-12">
                <form action="{{domain_route('company.admin.downloadvssalesreports')}}" method="post" id="searchForm">
                  @csrf
                  <div class="row">
                    <div class="col-sm-4">
                      <select id="search_type" name="search_type" class="select2"
                        ...
                        <option value="1"> Party Order Report</option>
                        <option value="2"> Salesman Order Report</option>
                        <option value="3"> Parties Order Report</option>
                        <option value="4"> Salesmen Order Report</option>
                      </select>
                    </div>
                    <div class="col-sm-4">
                      ...
                      <span class="sales_party_select" ></span>
                    </div>
                    <div class="col-sm-4">
      ...
      $('#searchForm').on('submit', function (event) {
          ...
          if (search_type != "") {
              $.ajax({
                  ...
                  success: function (data) {
                    if(data.msg["gen_msg"]){
                      alert(data.msg["gen_msg"]);
                      location.reload();
                    }else{
                      alert(data.msg["fail_msg"]);
                    }
                  },
                  error: function (jqXHR, textStatus, errorThrown, data) {
                      $('.sales_party_select').html('');
