...
@section('content')
      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          ...
          <div class="box-header">
            ...
            <a href="{{ domain_route('company.admin.brand.create') }}" class="btn btn-primary pull-right"
            ...
            <span id="brandexports" class="pull-right"></span>
              ...
              @foreach($brands as $brand)
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="#" class="edit-modal" data-id="{{$brand->id}}"
                  ...
                  <td>
                    ...
                    <a href="{{ domain_route('company.admin.brand.edit',[$brand->id]) }}" class="btn btn-warning btn-sm"
                       style="    padding: 3px 6px;"><i class="fa fa-edit"></i></a>


                    @if(checkBrandToDelete($brand->id))


                      <a class="btn btn-danger btn-sm delete" data-mid="{{ $brand->id }}"
                         data-url="{{ domain_route('company.admin.brand.destroy', [$brand->id]) }}" data-toggle="modal"
  ...
  <div class="modal modal-default fade" id="delete" tabindex="-1" brand="dialog" aria-labelledby="myModalLabel">
      ...
      <div class="modal-content">
        ...
        <form method="post" class="remove-record-model">
          ...
          <div class="modal-body">
            ...
            <input type="hidden" name="brand_id" id="m_id" value="">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form class="form-horizontal" role="form" id="changeStatus" method="POST"
                action="{{URL::to('admin/brand/changeStatus')}}">
  ...
  <form method="post" action="{{domain_route('company.admin.brand.customPdfExport')}}" class="pdf-export-form hidden"
    id="pdf-generate">
    {{csrf_field()}}
...
@section('scripts')
  ...
  <script>
      ...
      $(document).ready(function () {
          ...
          @if (strpos(URL::previous(), domain_route('company.admin.brand')) === false)  
                  var activeRequestsTable = $('#brands').DataTable();
      ...
      var newExportAction = function (e, dt, button, config) {
        ...
        table.rows({"search":"applied" }).every( function () {
          ...
          if($.inArray("status", propertiesArray) != -1)  row["status"] = this.data()[2].replace(/<[^>]+>/g, '').trim();
          data.push(row);
        });
