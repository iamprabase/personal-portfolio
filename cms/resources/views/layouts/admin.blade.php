...
<div class="sidebar-main">
  <div class="sidebar-header">
    <a href="{{ domain_route('shop.admin.home') }}" title="{{ config('app.name') }}"><img
          src="{{ asset('shop/admin/img/logo.png') }}"></a>
  </div>
  <ul class="sidebar-nav">
    ...
    <li class="nav-item filled reverse"><a class="item" href="{{ domain_route('shop.home') }}"
                                           onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
                                           title="Logout"><i class="icon fas fa-power-off"></i></a></li>
  </ul>
</div>
