...
<script>
  ...
  const planModules = @json($planModules);
  ...
  $(document).ready(function () {
    allModules.map((module, index) => {
      let checkBox = `<input class="switches ${module.field}" name="module[${module.field}]" id="${module.field}" type="checkbox" ${$.inArray(module.field, planModules) !== -1?"checked":""}/>`
