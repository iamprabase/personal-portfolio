...
<section class="content">
  ...
  <div class="box box-default">
    ...
    <div class="box-body">
      ...
      {!! Form::open(['route' => ['app.custom-plan.update', $plan->id],'autocomplete'=>'off', 'method' => 'PATCH' ]) !!}
      <div class="col-xs-12">
...
<script>
  ...
  const planModule = @json($plan->modules->pluck('name'));
  ...
  $(document).ready(function () {
    allModules.map((module, index) => {
      let checkBox = `<input class="switches ${module.field}" name="module[]" id="${module.field}" type="checkbox" value="${module.id}" ${$.inArray(module.name, planModule) == -1 ? "":"checked"} />`
  ...
  $(document).on('click', '.switches', function () {
    ...
    handleAdditionalModuleCheckBoxes();
